...
import { type ArtData, type ColorPalette } from "@/lib/artGenerator";
...
export function ArtRenderer({
  ...
  const colors = artData.colors as ColorPalette;
        ...
        >
          <defs>
            <radialGradient id={`swirlGrad-${size}`} cx="50%" cy="50%">
              <stop offset="0%" stopColor={colors.swirl} stopOpacity={artData.complexity / 100 * opacity} />
          ...
          {artData.elements.map((element, i) => {
